...
//  TestSomeView
//
//  Created by Trixie Lulamoon on 2022/6/7.
//
...
struct TripMainView: View {
    ...
    var body: some View {
        ZStack {
            GeometryReader { outerView in
                ...
                .gesture(
                    !self.isCardTapped ? CardDragMove(outerView: outerView) : nil
                )//end .gesture
            }// end GeometryReader
    ...
    // body card drag gestrue
    func CardDragMove(outerView: GeometryProxy) -> some Gesture {
        DragGesture()
